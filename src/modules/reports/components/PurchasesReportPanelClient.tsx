...
export function PurchasesReportPanelClient() {
  const {
    ...
    reportType: ReportTypeEnum.PURCHASES,
    schema: PurchasesReportFiltersSchema,
    yearsEndpoint: "/reports/purchases/available-years",
    monthsEndpoint: "/reports/purchases/available-months",
  })
  ...
  return (
    <div className="rounded-box border border-base-300 bg-base-100 p-4 space-y-4">
      ...
      <PartyMultiSelector
        ...
        title="Seleccionar proveedores para el reporte"
      />
    </div>
  )
}
