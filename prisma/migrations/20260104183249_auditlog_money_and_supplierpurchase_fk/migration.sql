-- CreateEnum
CREATE TYPE "AuditEntityType" AS ENUM ('SALES_NOTE', 'SUPPLIER_PURCHASE', 'PAYMENT');

-- CreateEnum
CREATE TYPE "AuditAction" AS ENUM ('CREATE', 'UPDATE');

-- CreateEnum
CREATE TYPE "AuditChangeKey" AS ENUM ('SALES_NOTE_SUBTOTAL', 'SALES_NOTE_DISCOUNT_TOTAL', 'SALES_NOTE_TOTAL', 'SALES_NOTE_BALANCE_DUE', 'SUPPLIER_PURCHASE_TOTAL', 'SUPPLIER_PURCHASE_BALANCE_DUE', 'PAYMENT_AMOUNT', 'PAYMENT_OCCURRED_AT');
...
CREATE TABLE "AuditLog" (
    ...
    "rootEntityType" "AuditEntityType" NOT NULL,
...
-- CreateIndex
CREATE INDEX "AuditLogChange_key_idx" ON "AuditLogChange"("key");
